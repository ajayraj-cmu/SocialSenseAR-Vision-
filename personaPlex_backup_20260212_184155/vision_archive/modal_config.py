...
GEMINI_MODEL = "gemini-2.0-flash-exp"  # Fast + accurate for scene understanding
...
AUDIO_ENABLED = False  # Disabled by default (handle on client for lower latency)
...
# Note: Modal containers need engines to be included in the image.
# If using TRT, add them via .add_local_file() in modal_app.py
